...
- **C4 (debt reconciliation, docs-only)**: new OPEN **ARCH-012** in docs/DEBT_REGISTER.md (composed V4 engine omits legacy `scoring.entregadas`/`descartadas` detail; no current V4 consumer; resolution requires an explicit recognizer/domain contract; deferred owner T14 #18). ARCH-004 stays DONE and now points to ARCH-012 instead of embedding the residual.
